...
// 2. analyzeAssetSentiment    — sentimiento para BTC o ETH (caché 2h)
// 3. translateHeadlines       — traducción de titulares al español (caché 2h)
// 4. analyzeCalendarRisk      — modulación de decisión por eventos macro (caché 4h)
// 5. generatePortfolioInsight — nota personalizada según posición del usuario (caché 1h)
 ...
 * Versión genérica de analyzeGoldSentiment para activos cripto.
 *
...
/**
 * Analiza futuros perpetuos de oro (XAUUSDT) y determina dirección + leverage óptimo.
 *
 * @param {object} technicals   - { rsi, trendShort, trendLong, atr, atrPercent, currentZone }
 * @param {object} goldContext  - contexto macro/noticias del oro (igual que PAXG)
 * @param {number} fundingRate  - funding rate actual en % cada 8h
 * @param {number} maxLeverage  - máximo leverage que el usuario tolera (1-20)
